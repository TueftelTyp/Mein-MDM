...
namespace PersonData
{
    public partial class PersonForm : Form
    {
        ...
        private void btnAdd_Click_1(object sender, EventArgs e)
        {
            ...
            string sql = @"INSERT INTO Persons (FirstName, LastName, Strasse, Hausnummer, PLZ, Ort, Land, Geburtsdatum, Firma, Telefon, Mail, Bemerkung) 
                           VALUES (@FirstName, @LastName, @Strasse, @Hausnummer, @PLZ, @Ort, @Land, @Geburtsdatum, @Firma, @Telefon, @Mail, @Bemerkung)";
        ...
        private void LoadPersonDataFromListBox()
        {
            if (lbPerson.SelectedIndex != -1)
            {
                string selectedPerson = lbPerson.SelectedItem.ToString().TrimEnd(',', ' ');
